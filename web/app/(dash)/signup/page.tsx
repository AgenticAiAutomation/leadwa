...
export default function SignupPage() {
  ...
  const handleEmailSignup = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch('https://api.leadwa.co/auth/signup', {
        method: 'POST',
        headers: {
    ...
    <div className="min-h-screen bg-paper flex items-center justify-center px-4 py-8">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white p-8 rounded-lg shadow-lg">
          <h2 className="text-2xl font-bold text-ink mb-6">Create your account</h2>
          ...
          <div className="mt-6 text-center text-sm text-ink/60">
            ...
            <a href="/login" className="text-bottle-green font-semibold hover:underline">
              Login
            </a>
          </div>
        </div>
